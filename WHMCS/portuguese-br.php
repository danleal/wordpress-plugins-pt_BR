...
$_LANG['announcementsolder'] = "Artigos antigos";
...
$_LANG['sidebars']['viewAccount']['billingInformation'] = "Informações de Cobrança";
$_LANG['sidebars']['viewAccount']['contacts/subAccounts'] = "Contatos/Sub-contas";
$_LANG['sidebars']['viewAccount']['changePassword'] = "Mudar Senha";
$_LANG['sidebars']['viewAccount']['securitySettings'] = "Opções de Segurança";
$_LANG['sidebars']['viewAccount']['emailHistory'] = "Histórico de Emails";

$_LANG['aboutsecurityquestions'] = "Porque perguntas de segurança?";
$_LANG['registersecurityquestionblurb'] = "Perguntas de segurança vão lhe prover uma maior proteção, assim para mudar os dados da sua conta será necessário fornecer as respostas certas.";
...
$_LANG['managecontacts'] = "Gerencie seus Contatos";
...
$_LANG['invoicesduemsg'] = "Você tem %s faturas atrasadas somando um total de %s";
$_LANG['noinvoicesduemsg'] = "Você não tem faturas atrasadas.";

$_LANG['expiringsoon'] = "Expirando em breve";

$_LANG['notice'] = "Notificado";
$_LANG['networkstatussubtitle'] = "Nóticias e Informações";
...
$_LANG['servername'] = "Servidor";
$_LANG['visitwebsite'] = "Visitar o Website";
$_LANG['whoisinfo'] = "Informações WHOIS";

$_LANG['tableshowing'] = "Mostrando _START_ até _END_ de _TOTAL_ entradas";
$_LANG['tableempty'] = "Mostrando 0 de 0 entradas";
$_LANG['tablefiltered'] = "(filtrado de _MAX_ entradas totais)";
...
$_LANG['tableentersearchterm'] = "Entrar termo de busca...";
...
$_LANG['masspayintro'] = "Pagar todas as faturas listadas abaixo em uma única transação, escolhendo a forma de pagamento";
$_LANG['masspaymentselectgateway'] = "Selecionar Gateway de Pagamento";

$_LANG['ticketfeedbackrequest'] = "Solicitação de Avaliação";
$_LANG['ticketfeedbackforticket'] = "para o Ticket #";

$_LANG['notifications'] = "Notificações";
$_LANG['notificationsnone'] = "Você não tem notificações nesse momento.";

$_LANG['creditcardnonestored'] = "Sem cartão no arquivo";

$_LANG['kbviewingarticlestagged'] = "Ver artigos com tags";

$_LANG['domainprivatenameservers'] = "Nameservers Privados";

$_LANG['transferinadomain'] = "Transferir para um domínio";

$_LANG['nodomainextensions'] = "Não existem extensões de domínio configuradas para compra";

$_LANG['homebegin'] = "Comece a busca pelo seu domínio perfeito...";
$_LANG['howcanwehelp'] = "Como podemos ajudá-lo hoje?";
$_LANG['exampledomain'] = "ex: seudominio.com.br";
$_LANG['buyadomain'] = "Comprar um domínio";
$_LANG['orderhosting'] = "Assinar Hospedagem";
$_LANG['makepayment'] = "Pagamentos";
$_LANG['getsupport'] = "Suporte";

$_LANG['news'] = "Notícias";
$_LANG['allthelatest'] = "Novas notícias de";
$_LANG['readmore'] = "Leia mais";
$_LANG['noannouncements'] = "Nenhum artigo para mostrar";

$_LANG['kbsearchexplain'] = "Alguma dúvida? Comece sua busca por aqui.";
$_LANG['readyforquestions'] = "Estamos prontos e aguardando a sua pergunta";

$_LANG['restrictedpage'] = "Essa área é restrita";
$_LANG['enteremail'] = "Seu email";

$_LANG['passwordtips'] = "<strong>Dicas para uma senha forte</strong><br />Use letras maiúsculas e minúsculas<br />Inclua ao menos um simbolo (# $ ! % &amp; etc...)<br />Não use palavras comuns";

$_LANG['regdate'] = "Data de Reg";
$_LANG['nextdue'] = "Próximo Vencimento";

$_LANG['domaincheckertagline'] = "Encontre o domínio perfeito para você...";
$_LANG['findyourdomain'] = "Encoontre seu novo domínio";
$_LANG['searchtermrequired'] = "Você precisa entrar com uma palavra ou domínio para pesquisar";
$_LANG['unabletolookup'] = "Desculpa, não foi possível buscar com esse termo";
$_LANG['invalidchars'] = "Por favor, remova espaços ou caracteres especiais";
$_LANG['bulkoptions'] = "Opções em Massa";
$_LANG['checkingdomain'] = "Conferindo se o domínio está disponível...";
$_LANG['domainsgotocheckout'] = "Ir ao pagamento";
$_LANG['domainssearchresults'] = "Resultados da Busca";
$_LANG['domainssuggestions'] = "Sugestões";
$_LANG['domainsothersuggestions'] = "Você também pode se interessar por esses domínios alternativos";
$_LANG['domainsmoresuggestions'] = "Me de mais sugestões!";
$_LANG['domainssuggestionswarnings'] = "Domínios sugeridos nem sempre estarão disponíveis. A disponibilidade pode mudar até o momento do pagamento.";
$_LANG['disclaimers'] = "Avisos";
$_LANG['tldpricing'] = "TLD preços";
$_LANG['alltldpricing'] = "Todos os preços TLD";

$_LANG['quotesdesc'] = "Cotações geradas para você";
$_LANG['quotesrejected'] = "Rejeitado";

$_LANG['ticketsyourhistory'] = "Seu histórico de tickets";

$_LANG['clientareaemaildesc'] = "Seu histórico de email conosco";

$_LANG['sslconfssl'] = "Configurar SSL";
$_LANG['sslnoconfigurationpossible'] = "A configuração já foi concluída! Por favor, entre em contato com o suporte se houver algum problema.";

$_LANG['adminloggedin'] = "Você está atualmente logado como admin.";
$_LANG['returntoadminarea'] = "Sair & retornar a área administrativa";
$_LANG['adminmasqueradingasclient'] = "Você está atualmente mascarado como cliente.";
$_LANG['logoutandreturntoadminarea'] = "Sair & retornar a área administrativa";

$_LANG['supportAndUpdatesExpired'] = "Suporte & Atualizações estão desativadas";
$_LANG['supportAndUpdatesExpiredLicense'] = "Seu periodo de Suporte & Atualizações expirou";
$_LANG['supportAndUpdatesRenewalRequired'] = "Renova sua assinatura para acessar os downloads.";
$_LANG['supportAndUpdatesClickHereToRenew'] = "Clique aqui para renovar";

$_LANG['pwresetemailneeded'] = "Esqueceu a senha? Coloque o email no campo abaixo para iniciar o processo de recuperação";

$_LANG['quotestageexpired'] = "Expirado";

$_LANG['ticketinfo'] = "Informações do Ticket";
$_LANG['customfield'] = "Campos Customizados";
...
$_LANG['domainsExpiringInTheNext30Days'] = "Expirando nos próximos 30 Dias";
$_LANG['domainsExpiringInTheNext90Days'] = "Expirando nos próximos 90 Dias";
$_LANG['domainsExpiringInTheNext180Days'] = "Expirando nos próximos 180 Dias";
$_LANG['domainsExpiringInMoreThan180Days'] = "Expirando em mais de 180 Dias";

$_LANG['kbtagcloud'] = "Tag Cloud";

$_LANG['cancellationrequestedexplanation'] = "Tem uma excelente explicação para o cancelamento desse produto / serviço";
$_LANG['cancellationrequested'] = "Pedido de Cancelamento";

$_LANG['yourrecenttickets'] = "Seus tickets recentes";
...
$_LANG['outOfStockProductRemoved'] = "Um produto do estoque foi automáticamente removido do carrinho";

$_LANG['subaccountpermsquotes'] = "Ver & Aceitar Cotações";
...
$_LANG['quoteacceptagreetos'] = "Para aceitar a proposta por favor, concorde com os nossos Termos de Serviço.";
$_LANG['quoteacceptcontractwarning'] = "Ao aceitar uma proposta você automáticamente estará assinando um novo contrato e não poderá cancela-lo de imediato.";

// Client alerts
$_LANG['clientAlerts']['creditCardExpiring'] = "O seu cartão de crédito :creditCardType-:creditCardLastFourDigits expira em :days dias. Por favor, atualize assim que possível.";
$_LANG['clientAlerts']['domainsExpiringSoon'] = "Você tem :numberOfDomains domínio(s) expirando nos próximos :days dias.";
$_LANG['clientAlerts']['invoicesUnpaid'] = "Você tem :numberOfInvoices fatura(s) próximas do vencimento. Faça o pagamento o quanto antes.";
$_LANG['clientAlerts']['invoicesOverdue'] = "Você tem :numberOfInvoices fatura(s) vencidas com um balanço total de :balanceDue. Pague elas agora e evite interrupções nos seus serviços.";
$_LANG['clientAlerts']['creditBalance'] = "Você tem um balanço de crédito no valor de :creditBalance.";

// Client homepage panels
$_LANG['clientHomePanels']['unpaidInvoices'] = "Faturas a pagar";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Você tem :numberOfInvoices fatura(s) próximas do vencimento. Faça o pagamento o quanto antes.";
$_LANG['clientHomePanels']['overdueInvoices'] = "Faturas Vencidas";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Você tem :numberOfInvoices fatura(s) vencidas com um balanço total de :balanceDue. Pague elas agora e evite interrupções nos seus serviços.";
$_LANG['clientHomePanels']['domainsExpiringSoon'] = "Domínios Expirando";
$_LANG['clientHomePanels']['domainsExpiringSoonMsg'] = "Você tem :numberOfDomains domínio(s) expirando nos próximos :days dias.";
$_LANG['clientHomePanels']['activeProductsServices'] = "Produtos / Serviços Ativos";
$_LANG['clientHomePanels']['activeProductsServicesNone'] = "Parece que você não tem nenhum produto ou serviço ativo ainda. <a href=\"cart.php\">Comece agora</a>.";
...
$_LANG['clientHomePanels']['recentSupportTicketsNone'] = "Nenhum ticket encontrado. Se estiver precisando de ajuda <a href=\"submitticket.php\">abra um novo ticket</a>.";
$_LANG['clientHomePanels']['affiliateSummary'] = "Seu saldo atual de comissões é de :commissionBalance. Você só precisa de mais :amountUntilWithdrawalLevel antes de solicitar o primeiro saque.";

$_LANG['upgradeNotPossible'] = "Atualizar esse produto não é possível. Se você acredita que isso é um erro entre em contato com nosso suporte ou volte e selecione outra opção.";

$_LANG['hostingInfo'] = "Informações de Hospedagem";
$_LANG['additionalInfo'] = "Informações Adicionais";
$_LANG['resourceUsage'] = "Consumo dos Recursos";
$_LANG['primaryIP'] = "IP Primario";
$_LANG['assignedIPs'] = "IPs Selecionados";
$_LANG['diskSpace'] = "Espaço em Disco";
$_LANG['bandwidth'] = "Bandwidth";
$_LANG['registered'] = "Registrado";
$_LANG['upgrade'] = "Upgrade";

$_LANG['downdoadsdesc'] = "Manuais, programsa e outros arquivos";

$_LANG['doToday'] = "O que você gostária de fazer hoje?";
$_LANG['changeDomainNS'] = "Mude os Nameservers para os quais o seu domínio aponta";
$_LANG['updateWhoisContact'] = "Atualize as informações do WHOIS para o seu domínio";
$_LANG['changeRegLock'] = "Mude o status do registrar para esse domínio";
$_LANG['renewYourDomain'] = "Renove o seu domínio";

$_LANG['oops'] = "Oops";
$_LANG['goback'] = "Voltar";
$_LANG['returnhome'] = "Retornar a Home";
$_LANG['blankCustomField'] = "(sem valor)";

$_LANG['viewAll'] = "Ver Todos";
$_LANG['moreDetails'] = "Mais Detalhes";

$_LANG['clientHomeSearchKb'] = "Digite uma pergunta para buscarmos na base de conhecimento...";

$_LANG['whoisContactWarning'] = "É importante manter as informações do seu domínio sempre atualizadas para não perder o controle dele.";

$_LANG['paymentstodate'] = "Pagamentos para a Data";
$_LANG['balancedue'] = "Valor Total";
...
$_LANG['domaincheckernomoresuggestions'] = "Esses são todos os resultados para você! Se ainda não encontrou o que procura, tente uma busca diferente.";
$_LANG['domaincheckerunabletooffertld'] = "Infelizmente você não pode registrar esse TLD no momento";
$_LANG['domaincheckerbulkplaceholder'] = "Insira até 20 domínios.\nCada um em uma linha separada.\n\nExemplos:\nexemplo.com.br\nexemplo.net";

$_LANG['domainchecker']['suggestiontakentitle'] = "Domínio Indisponível";
$_LANG['domainchecker']['suggestiontakenmsg'] = "Infelizmente o domínio selecionado não está disponível. O domínio pode ter sido registrado recentemente. Por favor, retorne e tente com outro domínio.";
$_LANG['domainchecker']['suggestiontakenchooseanother'] = "Escolher outro domínio";

$_LANG['domainchecker']['alreadyincarttitle'] = "Já está no carrinho";
$_LANG['domainchecker']['alreadyincartmsg'] = "Esse domínio já está no carrinho. Siga para o pagamento e complete o seu pedido.";
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "Pagar Agora";

$_LANG['genericerror']['title'] = "Oops, algo deu errado!";
$_LANG['genericerror']['msg'] = "Por favor, tente novamente ou entre em contato com o nosso suporte.";
...
$_LANG['licensingaddon']['licensekey'] = "Chave da Licença";
...
$_LANG['licensingaddon']['reissue'] = "Re-usar a Licença";
...
$_LANG['affiliateWithdrawalSummary'] = "Não foi possível processar o seu saque. O minimo solicitado é de :amountForWithdrawal.";
...
$_LANG['cPanel']['addonsExtras'] = "Adicionais & Extras";
$_LANG['cPanel']['purchaseActivate'] = "Comprar & Ativar";

$_LANG['cPanel']['usageStats'] = "Estátisticas de Consumo";
$_LANG['cPanel']['diskUsage'] = "Uso do Disco";
$_LANG['cPanel']['bandwidthUsage'] = "Consumo de Bandwidth";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "Você está próximo do seu limite de banda.";
$_LANG['cPanel']['usageStatsDiskLimitNear'] = "Você está próximo do seu limite de espaço.";
$_LANG['cPanel']['usageUpgradeNow'] = "Atualizar Agora";
$_LANG['cPanel']['usageLastUpdated'] = "Última Atualização";

$_LANG['cPanel']['quickShortcuts'] = "Atalhos Rápidos";
$_LANG['cPanel']['emailAccounts'] = "Contas de Email";
$_LANG['cPanel']['forwarders'] = "Redirecionamentos";
$_LANG['cPanel']['autoresponders'] = "Auto-respostas";
$_LANG['cPanel']['fileManager'] = "Gerenciador de Arquivos";
$_LANG['cPanel']['backup'] = "Backup";
$_LANG['cPanel']['subdomains'] = "Sub-domínios";
$_LANG['cPanel']['addonDomains'] = "Adicionais Domínios";
$_LANG['cPanel']['cronJobs'] = "Cron Jobs";
$_LANG['cPanel']['mysqlDatabases'] = "Bases MySQL";
$_LANG['cPanel']['phpMyAdmin'] = "phpMyAdmin";
$_LANG['cPanel']['awstats'] = "Awstats";

$_LANG['cPanel']['createEmailAccount'] = "Crie uma conta de email agora";
$_LANG['cPanel']['usernamePlaceholder'] = "Seu Nome";
$_LANG['cPanel']['passwordPlaceholder'] = "Senha escolhida";
$_LANG['cPanel']['create'] = "Criar";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "Conta de email criada com sucesso!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "Criação de email falhou: ";

$_LANG['cPanel']['packageNotActive'] = "Esse é o pacote atual de hospedagem";
$_LANG['cPanel']['statusPendingNotice'] = "Você não pode usar essa conta de hospedagem até que ela seja ativada.";
$_LANG['cPanel']['statusSuspendedNotice'] = "Você não pode usar ou gerenciar esse pacote até que ele seja reativado.";

$_LANG['cPanel']['billingOverview'] = "Visão Geral de Cobrança";

$_LANG['liveHelp']['chatNow'] = "Entrar no Chat";

$_LANG['quotes'] = "Orçamentos";

$_LANG['productMustBeActiveForModuleCmds'] = "O produto precisa estar ativo pra executar essa ação";
$_LANG['domainCannotBeManagedUnlessActive'] = "Esse domínio não está ativo e não poderá ser gerenciado.";

$_LANG['actionRequiresAtLeastOneDomainSelected'] = 'Por favor, selecione ao menos um domínio para executar essa ação';
$_LANG['clientAreaProductDownloadsAvailable'] = "Os itens para download a seguir estão disponíveis para o seu produto";
$_LANG['clientAreaProductAddonsAvailable'] = "Adicionais estão disponíveis para o seu produto / serviço. <a href=\"cart.php?gid=addons\">Clique aqui para ver &amp; comprar &raquo;</a>";
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "Nós recomendamos que você ative a Autenticação em 2 passos..";
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "Perguntas de segurança vão lhe prover uma maior proteção, assim para mudar os dados da sua conta será necessário fornecer as respostas certas.";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "Perguntas de segurança ajudam a proteger o seus dados, a sua conta e garante uma segurança maior para os seus dados.";
